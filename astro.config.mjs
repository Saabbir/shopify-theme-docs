  ...
  integrations: [
    starlight({
      ...
      sidebar: [
        ...
        {
          label: '6. Internationalization & Locales',
          items: [
            { label: 'Overview', slug: 'internationalization-and-locales' },
            { label: '6.1. Internationalization & RTL', slug: 'internationalization-and-locales/internationalization-and-rtl' },
            { label: '6.2. Managing Locale Files', slug: 'internationalization-and-locales/managing-locale-files' },
          ],
        },
        {
          label: '7. Style Guides',
          items: [
            { label: 'Overview', slug: 'style-guides' },
            { label: '7.1. CSS Style Guide', slug: 'style-guides/css' },
            { label: '7.2. JavaScript & Web Components', slug: 'style-guides/javascript-and-web-components' },
            { label: '7.3. Web Components Guideline', slug: 'style-guides/web-components' },
            { label: '7.4. Liquid Style Guide', slug: 'style-guides/liquid' },
            { label: '7.5. Clean Code Principles', slug: 'style-guides/clean-code-principles' },
            { label: '7.6. Third-Party Libraries', slug: 'style-guides/third-party-libraries' },
            { label: '7.7. Theme Editor & Storefront Events', slug: 'style-guides/theme-editor-events' },
          ],
        },
        {
          label: '8. Performance & Accessibility',
          items: [
            { label: 'Overview', slug: 'performance-and-accessibility' },
            { label: '8.1. Accessibility Deep Dive', slug: 'performance-and-accessibility/accessibility-deep-dive' },
            { label: '8.2. Performance Strategy & Critical Rendering Path', slug: 'performance-and-accessibility/performance-strategy' },
            { label: '8.3. Media Optimization: Images, Video & 3D', slug: 'performance-and-accessibility/media-optimization' },
          ],
        },
        {
          label: '9. AI-Assisted Development',
          items: [
            { label: 'Overview', slug: 'ai-assisted-development' },
            { label: '9.1. AI Coding Concepts (Agents, MCP, Skills, Commands, Plugins)', slug: 'ai-assisted-development/ai-coding-concepts' },
            { label: '9.2. Managing & Amending AI Rules', slug: 'ai-assisted-development/managing-ai-rules' },
            { label: "9.3. Shopify's Official AI Toolkit", slug: 'ai-assisted-development/shopify-ai-toolkit' },
            { label: '9.4. Figma MCP & Dev Mode', slug: 'ai-assisted-development/figma-mcp-and-dev-mode' },
            { label: '9.5. Figma to Code Workflow', slug: 'ai-assisted-development/figma-to-code-workflow' },
            { label: '9.6. Claude Code Custom Commands', slug: 'ai-assisted-development/claude-code-custom-commands' },
            { label: '9.7. Claude Code Subagents', slug: 'ai-assisted-development/claude-code-subagents' },
            { label: '9.8. Writing Prompts That Work', slug: 'ai-assisted-development/writing-prompts-that-work' },
          ],
        },
        {
          label: '10. GitHub Workflow',
          items: [
            { label: 'Overview', slug: 'github-workflow' },
            { label: '10.1. Pull Requests & Review', slug: 'github-workflow/pull-requests-and-review' },
            { label: '10.2. CI Automation', slug: 'github-workflow/ci-automation' },
          ],
        },
        {
          label: '11. Quality & Validation',
          items: [
            { label: 'Overview', slug: 'quality-validation' },
            { label: '11.1. Theme Check & Linting', slug: 'quality-validation/theme-check-and-linting' },
            { label: '11.2. Manual QA Checklist', slug: 'quality-validation/manual-qa-checklist' },
            { label: '11.3. Pre-Submission Checklist', slug: 'quality-validation/pre-submission-checklist' },
          ],
        },
        {
          label: '12. Publishing to Theme Store',
          items: [
            { label: 'Overview', slug: 'publishing' },
            { label: '12.1. Partner Dashboard Setup', slug: 'publishing/partner-dashboard-setup' },
            { label: '12.2. Store Setup for Submission', slug: 'publishing/store-setup-for-submission' },
            { label: '12.3. Packaging & Submitting', slug: 'publishing/packaging-and-submitting' },
            { label: '12.4. Review Process & Rejections', slug: 'publishing/review-process-and-rejections' },
            { label: '12.5. After Approval', slug: 'publishing/after-approval' },
          ],
        },
        {
          label: '13. Tooling & Config',
          items: [
            { label: 'Overview', slug: 'tooling-config' },
            { label: '13.1. Project Files Explained', slug: 'tooling-config/project-files' },
            { label: '13.2. Packaging: Theme Store-Only Directories', slug: 'tooling-config/packaging-exclusions' },
            { label: '13.3. Tailwind CSS & Alpine.js Build Setup', slug: 'tooling-config/tailwind-and-alpine-build-setup' },
          ],
        },
        {
          label: '14. Learning Articles',
          items: [
            { label: 'Overview', slug: 'learning-articles' },
            { label: '14.1. CSS Deep Dive', slug: 'learning-articles/css-deep-dive' },
            { label: '14.2. JavaScript & Web Components Deep Dive', slug: 'learning-articles/javascript-and-web-components-deep-dive' },
            { label: '14.3. Liquid Global Objects Reference', slug: 'learning-articles/liquid-global-objects' },
            { label: '14.4. Writing Maintainable Code at Scale', slug: 'learning-articles/writing-maintainable-code-at-scale' },
          ],
        },
        {
          label: '15. Reference',
          items: [
            ...
            { label: '15.1. Cheatsheet', slug: 'reference/cheatsheet' },
            { label: '15.2. Glossary', slug: 'reference/glossary' },
            { label: '15.3. Tools Directory', slug: 'reference/tools-directory' },
          ],
        },
      ],
    }),
