...
- Read this page once, all the way through, before you move on to the rest of section 12. If MCP, skill, command, subagent, or plugin is new to you, the other pages assume you already know which is which.
