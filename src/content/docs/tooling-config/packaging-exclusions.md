...
| Docs | `README.md`, this handbook itself, `docs/` (for example, the per-section build records `/figma-to-section` writes, see [Claude Code Custom Commands](/ai-assisted-development/claude-code-custom-commands/)) |
